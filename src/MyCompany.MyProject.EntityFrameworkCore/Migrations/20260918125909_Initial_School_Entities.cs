...
{
    /// <inheritdoc />
    public partial class Initial_School_Entities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainSubjectId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_Subjects_MainSubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadTeacherId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockedByTeacherId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QlsGradeLockStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QlsGradeLockStatuses_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QlsGradeLockStatuses_Semesters_SemesterId",
                        column: x => x.SemesterId,
                        principalTable: "Semesters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QlsGradeLockStatuses_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectId = table.Column<int>(type: "int", nullable: false),
                    SemesterId = table.Column<int>(type: "int", nullable: false),
                    ScoreTX1 = table.Column<decimal>(type: "decimal(4,2)", nullable: true),
                    ScoreTX2 = table.Column<decimal>(type: "decimal(4,2)", nullable: true),
                    ScoreTX3 = table.Column<decimal>(type: "decimal(4,2)", nullable: true),
                    ScoreGK = table.Column<decimal>(type: "decimal(4,2)", nullable: true),
                    ScoreCK = table.Column<decimal>(type: "decimal(4,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeRecords_StudentId_SubjectId_SemesterId",
                table: "GradeRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QlsGradeLockStatuses_ClassId_SubjectId_SemesterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QlsGradeLockStatuses_SemesterId",
                table: "QlsGradeLockStatuses",
                column: "SemesterId");

            migrationBuilder.CreateIndex(
                name: "IX_QlsGradeLockStatuses_SubjectId",
                table: "QlsGradeLockStatuses",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_MainSubjectId",
                table: "Teachers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeachingAssignments_ClassId_SubjectId_SemesterId",
